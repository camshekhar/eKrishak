...
<title>Vendor SignUp - eKrishak</title>
</head>
<body>
	...
	<section
		style="background-image: url('assets/img/ploughing farmer.jpg'); height: 100% !important; padding: 10px 0px; background-color: #eee;">
			...
			<div class="row d-flex justify-content-center align-items-center">
				...
				<div class="col-lg-12 col-xl-11">
					...
					<div class="card text-black" style="border-radius: 25px;">
						<h1 class="text-dark text-center mt-5">Welcome, Vendors 🧑‍🌾</h1>
										...
										<div class="d-flex flex-row align-items-center mb-4">
											...
											<div class="form-outline flex-fill mb-0">
												...
												<label class="form-label" for="form3Example1c">Mobile
													...
													class="form-control" name="mobile" maxlength="10" required />
											</div>
										</div>
										...
										<div class="form-check d-flex justify-content-center">
											<p class="mb-5 pb-lg-2" style="color: #393f81;">
												Already have an account - <a
													class="text-decoration-underline" href="vendorLogin.jsp"

	...
	<nav
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<% if(user.equals("Farmer")){ %>
				<a href="/eKrishak/farmer/farmerDashboard.jsp" class="nav-item nav-link">Home</a>
				 <a
					href="/eKrishak/crops/cropListing.jsp" class="nav-item nav-link active">List Crops</a> 
<!-- 					<a -->
...
<!-- 					Purchase</a> -->
				...
				<a href="#" class="nav-item nav-link">Home</a>
				 <a
					href="/eKrishak/crops/cropListing.jsp" class="nav-item nav-link active">List Crops</a> <a
					href="/eKrishak/vendor/vendorLogin.jsp" class="nav-item nav-link">Approve
					Purchase</a>
	...
	<section class="h-100 pt-4" style="background-color: #eee; border-radius:10px;  ">
			...
			<div
				...
				<div class="col-lg-8 col-xl-6">
					<div class="card rounded-3">
						<img
							src="../assets/img/cropList.webp"
							class="w-100"
							style="border-top-left-radius: .3rem; border-top-right-radius: .3rem;"
							alt="Sample photo">
						<div class="card-body p-4 p-md-5 w-100">
							<h3 class="mb-0 pb-2  text-center">Crop
								Info</h3>
								<hr>

							<form class="px-md-2" method="post" action="/eKrishak/crops/cropListingProcess.jsp">
							
							<div class="form-outline mb-4">
							<label class="form-label" for="form3Example1q"><%= user %> Id:</label>
									<input type="text" id="form3Example1q" class="form-control" disabled="disabled" value="<%= id %>" name="user_id"/>
									
								</div>

								<div class="form-outline mb-4">
									<label class="form-label" for="form3Example1q">Crop Name:</label>
									<input type="text" id="form3Example1q" class="form-control" name="cr_name"/>
									...
									<div class="  col-md-6 mb-4">
										...
										<label class="form-label" for="form3Example1q">Crop Type:</label>
										<select class="form-outline select p-2 cursor-pointer" name="cr_type">
											<option value="1" disabled selected>Select Crop Type</option>
									...
									<div class="form-outline mb-4">
									<label class="form-label" for="form3Example1q">Crop Quantity(KG):</label>
									<input type="text" id="form3Example1q" class="form-control" name="cr_quant"/>
									...
									<div class="form-outline mb-4">
									<label class="form-label" for="form3Example1q">Crop Price(₹/KG):</label>
									<input type="text" id="form3Example1q" class="form-control" name="cr_price"/>

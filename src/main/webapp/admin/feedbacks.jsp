...
try {
	...
	String query = "Select * from support_feedback where subject='feedback'";
	feedback = connection.getRecords(query);
		...
		<aside>
			...
			<div class="sidebar">
				<a href="/eKrishak/admin/adminDashboard.jsp" class="sidebar-link"
					...
					<h3>Drivers</h3>
				</a> <a href="/eKrishak/admin/feedbacks.jsp" class="sidebar-link active"
				...
				<div class="recent-orders">
					...
					<table>
						...
						<tbody>
							...
							<tr>
								<td><%=i%></td>
								<td><%=feedback.getInt("id")%></td>
								<td><%=feedback.getString("name").toUpperCase()%></td>
								<td><%=feedback.getString("mobile")%></td>
								<td><%=feedback.getString("subject")%></td>
								<td><%=feedback.getString("message")%></td>

  ...
  <div class="container">
    ...
    <div class="row d-flex justify-content-center align-items-center">
      ...
      <div class="col-lg-12 col-xl-11">
        ...
        <h1 class="text-dark mt-5">Welcome, Farmers 🧑‍🌾</h1>
              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="regProcess.jsp">
                  ...
                  <div class="form-check d-flex justify-content-center">
                   <p class="mb-5 pb-lg-2" style="color: #393f81;">Already have an account - <a class="text-decoration-underline" href="/eKrishak/farmerLogin.jsp"
...
<!--                   class="img-fluid" alt="Sample image"> -->
 ...
 <img src="../assets/img/team-3.jpg"
                  class="img-fluid" style=" height: 100vh !important;">

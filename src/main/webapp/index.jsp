...
<jsp:include page="navbar.html" flush="true"/>
    ...
    <div class="container-fluid banner mb-5">
        <div class="container">
            <div class="row gx-0">
                <div class="col-md-6">
                    <div class="bg-primary bg-cropselling d-flex flex-column justify-content-center p-5" style="height: 300px;">
                ...
                <div class="col-md-6">
                    <div class="bg-secondary bg-transportation d-flex flex-column justify-content-center p-5" style="height: 300px;">
...
<!--             <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="/">eKrishak</a>. All Rights Reserved. -->
<!--         </div> -->
<!--     </div> -->
<!--     Footer End -->
